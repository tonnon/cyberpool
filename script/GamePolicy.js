...
function GamePolicy(){
    ...
    let player1MatchScore = new Score(new Vector2(Game.size.x/2 - 450,108));
    let player2MatchScore = new Score(new Vector2(Game.size.x/2 + 450,108));
...
GamePolicy.prototype.drawScores = function(){
    Canvas2D.drawText("PLAYER " + (this.turn+1), new Vector2(Game.size.x/2 + 80,400), new Vector2(150,0), "#6B5FAB", "top", "Impact", "40px");
